...
const Sidebar = () => {
  ...
  return !togglevent ? null : (
    <div className="w-40 -my-1 shadow-md cursor-pointer px-1 ">
      <ul className="">
        <li className="flex px-2 py-3 hover:bg-slate-500 hover:rounded-sm h-12">
          <img className="h-5" src={homeicon} alt="" /> Home
        </li>
        <li className="flex px-2 hover:bg-slate-500 hover:rounded-sm h-12 items-center  ">
      ...
      <hr />
      <h4 className=" px-1 font-semibold flex  hover:bg-slate-500 hover:rounded-sm h-12  items-center ">
        <img className="h-5" src={Subscriptionsicon} alt="" />
        Subscriptions
      </h4>
      <ul className="">
        <li className="hover:bg-slate-500 hover:rounded-sm h-12 items-center flex px-2">
          Music
        </li>
        <li className=" hover:bg-slate-500 hover:rounded-sm h-12  items-center flex px-2">
          Sports
      ...
      <hr />
      <h2 className=" px-1  font-semibold  hover:bg-slate-500 hover:rounded-sm h-12  items-center flex ">
        Explore
      </h2>
      <ul>
        <li className="flex  px-2 hover:bg-slate-500 hover:rounded-sm h-12  items-center ">
        ...
        <li className="flex px-1  hover:bg-slate-500 hover:rounded-sm  items-center h-12">
          <img className="h-5 px-1" src={shoppingicon} alt="" />
          Shopping
        </li>
        <li className="flex  px-1 hover:bg-slate-500 hover:rounded-sm h-12  items-center ">
          <img className="h-5 px-1" src={gamingicon} alt="" />
          Gaming
        </li>
        <li className="flex  px-2   hover:bg-slate-500 hover:rounded-sm  items-center h-12 ">
